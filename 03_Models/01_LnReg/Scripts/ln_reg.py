...
if __name__ == "__main__":
    ...
    input_path = '/Users/tejakummarikuntla/Dev/image-generation/imaginea_assign/03_Models/01_LnReg/Inputs/input_data.csv'
    house_price_dataset = pd.read_csv(input_path)
    print(type(simple_linear_regression(house_price_dataset)))
